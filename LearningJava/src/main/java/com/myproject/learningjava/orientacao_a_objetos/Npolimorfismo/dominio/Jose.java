...
public class Jose extends Pessoa{
    private final double PORCENTAGEM_APOSENTADORIA_SALARIO_ALTO = 0.2;
    private final double PORCENTAGEM_APOSENTADORIA_SALARIO_BAIXO = 0.05;

    public Jose(String nome, int idade, double salario, Profissoes profissoes) {
