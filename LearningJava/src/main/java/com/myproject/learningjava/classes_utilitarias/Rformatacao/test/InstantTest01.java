...
public class InstantTest01 {
    public static void main(String[] args) {
        ...
        * formato ZULU time seguem o mesmo padrão/valor no mundo inteiro, assim evitando inconsistência de
        * dados.
        * OBS: Uma classe imutável significa que todas as alterações em um objeto só serão aceitas/feitas em
        * uma nova instância deste objeto
        * */
    }
}
